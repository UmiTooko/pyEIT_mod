...
def parse_args():
    ...
    parser.add_argument("--lung_filename", type = str, required = True, help="Idk")
...
def main():
    ...
    def get_difference_img_array(n_el = n_el, NewFrameSearchFlag = 1, idx = 0):
        pppp = "data/" + arg.lung_filename + ".txt"
...
#
        ...
        #print("Run time until the displaying is f
        # 
        # 
        # 
        # inished = {}\n".format(time.time()))
